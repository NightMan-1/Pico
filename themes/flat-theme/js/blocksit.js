(function($) {
	...
	var setPosition = function(obj, index) {
		...
		//fix ing aspect ratio, part 1
		var element = obj.find('img');
		var ratio = (element.width() / element.height());
		//console.log(element.width() + " " + ratio + " " +  element.height() + " " + (element.width()/ratio));
		...
		//fix ing aspect ratio, part 2
		element.height( (element.width() / ratio) );

		//var blockHeight = obj.outerHeight();
		var blockHeight = (element.width() / ratio);

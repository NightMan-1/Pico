...
/* @admin/articles.html */
class __TwigTemplate_a835633b586908e4b53e64f0239cb0ed0228fd0bf2ef044925d3b6f5a303a0ce extends Twig_Template
{
...
\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["page"]) {
            if ((twig_get_attribute($this->env, $this->getSourceContext(), $context["page"], "pagetype", array()) && (twig_get_attribute($this->env, $this->getSourceContext(), $context["page"], "pagetype", array()) == "infoblock-page"))) {
                // line 29
                echo "\t\t\t\t\t<tr class=\"article-control-line\">
\t\t\t\t\t\t<td style=\"width: 5em;\">";
                // line 30
                if (twig_get_attribute($this->env, $this->getSourceContext(), $context["page"], "thumbsmall", array())) {
                    echo "<img src=\"";
                    echo twig_get_attribute($this->env, $this->getSourceContext(), $context["page"], "thumbsmall", array());
                    echo "\" width=\"100%\">";
                }
                echo "</td>
\t\t\t\t\t\t<td>
...
\t\t\t\t\t\t<td style=\"width: 12em; white-space: nowrap;\">";
                // line 45
                echo twig_get_attribute($this->env, $this->getSourceContext(), $context["page"], "category", array());
                echo "</td>
\t\t\t\t\t\t<td style=\"width: 8em; white-space: nowrap;\">";
                // line 46
                echo twig_get_attribute($this->env, $this->getSourceContext(), $context["page"], "date", array());
                echo "</td>
\t\t\t\t\t</tr>
\t\t\t\t\t";
            }
...
\t\t\t\t\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["infoblock"]) {
            // line 79
            echo "\t\t\t\t\t\t\t\t\t<option value=\"";
            echo twig_get_attribute($this->env, $this->getSourceContext(), $context["infoblock"], "folder", array());
            echo "\">";
            echo twig_get_attribute($this->env, $this->getSourceContext(), $context["infoblock"], "name", array());
            echo "</option>
\t\t\t\t\t\t\t\t\t";
        }
        $_parent = $context['_parent'];
...
{%include \"@admin/footer.twig\" %}", "@admin/articles.html", "/Users/nightman/Dropbox/My Site/lib/pico_admin/templates/articles.html");
    }
}

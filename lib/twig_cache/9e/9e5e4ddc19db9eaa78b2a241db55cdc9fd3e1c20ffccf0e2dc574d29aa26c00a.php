...
/* blog-index.html */
class __TwigTemplate_145245452f36877b87cf2d8f5353fd81b0335d68eb6e6b5814ee8b8933ae89b6 extends Twig_Template
{
...
<section class=\"section section-center- article\">
    <div class=\"container\">
        ...
        ";
        // line 8
        if ($this->getAttribute(($context["filter"] ?? null), "name", array())) {
            // line 9
            echo "        <h2 class=\"section-title\" style=\"margin-bottom: 0; margin-top: 0.7em\"><span>Раздел: ";
            echo $this->getAttribute(($context["filter"] ?? null), "name", array());
            echo "</span></h2>
        ";
        }
        // line 11
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["article"]) {
            ...
            echo strip_tags($this->getAttribute($context["article"], "title", array()));
            ...
            // line 25
            echo twig_localized_date_filter($this->env, $this->getAttribute($context["article"], "date", array()), "full", "full", ($context["locale"] ?? null));
            echo "\">";
            echo twig_localized_date_filter($this->env, $this->getAttribute($context["article"], "date", array()), "medium", "none", ($context["locale"] ?? null));
            echo "</abbr></span>
                            </div>
                        </div>
                    </div>
                    ...
                    ";
            // line 30
            if ($this->getAttribute($context["article"], "thumbbig", array())) {
                // line 31
                echo "                    <a href=\"";
                echo $this->getAttribute($context["article"], "url", array());
                ...
                echo strip_tags($this->getAttribute($context["article"], "title", array()));
                echo "\" src=\"";
                echo $this->getAttribute($context["article"], "thumbbig", array());
                echo "\">
                    </a>
                    ";
            }
            ...
            echo "
                    ";
            // line 36
            if (($this->getAttribute($context["article"], "thumbbig", array()) && $this->getAttribute($context["article"], "excerpt", array()))) {
                // line 37
            ...
            echo "
                    ";
            // line 40
            if ($this->getAttribute($context["article"], "excerpt", array())) {
                // line 41
                echo "                    <p>";
                echo $this->getAttribute($context["article"], "excerpt", array());
                echo "</p>
                    ";
            }
            // line 43
            echo "
                    <div class=\"panel-footer\">
                        ";
            // line 45
            if ($this->getAttribute($context["article"], "tags", array())) {
                // line 46
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["tag"]) {
                    ...
                    echo "/";
                    echo $this->getAttribute($context["article"], "category", array());
                    echo "?tag=";
                    echo $context["tag"];
        ...
        if ((($context["total_pages"] ?? null) > 1)) {
            ...
            echo $this->getAttribute(($context["filter"] ?? null), "url", array());
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["page"]) {
                // line 66
                echo "                        <li><a ";
                if (($this->getAttribute($context["page"], "number", array()) == ($context["page_number"] ?? null))) {
                    echo "class=\"current\"";
                }
                echo " href=\"";
                ...
                echo $this->getAttribute(($context["filter"] ?? null), "url", array());
                echo "\">";
                echo $this->getAttribute($context["page"], "number", array());
                echo "</a></li>
                        ";
            }
            $_parent = $context['_parent'];
...
{%include \"footer.twig\" %}
", "blog-index.html", "C:\\Users\\NightMan\\Dropbox\\My Site\\themes\\nm2015\\blog-index.html");
    }
}

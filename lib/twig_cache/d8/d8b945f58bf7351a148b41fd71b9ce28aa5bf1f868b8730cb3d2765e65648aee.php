...
/* @admin/pages.html */
class __TwigTemplate_1f3afd396c5d04b9d44327efb0dc4601408d141e7f2724e4f2979fd08917c28d extends Twig_Template
{
...
<div class=\"content-wrapper\">
    ...
    <section class=\"content\">
        ...
        echo $this->getAttribute(($context["files_tree"] ?? null), "title", array());
        echo "
                        <span class=\"control\">
                            <a href=\"";
        // line 24
        echo $this->getAttribute(($context["files_tree"] ?? null), "url", array());
        echo "\" target=\"_blank\" title=\"открыть\" class=\"m-l-1\"><i class=\"fa fa-eye\"></i> перейти</a>
                            ";
        // line 25
        if (($this->getAttribute(($context["files_tree"] ?? null), "content_type", array()) == ".html")) {
            // line 26
            echo "                            <a href=\"";
            echo ($context["base_url"] ?? null);
            echo "/admin/edit?file=";
            echo twig_escape_filter($this->env, $this->getAttribute(($context["files_tree"] ?? null), "file", array()));
            echo "\" title=\"редактировать\"><i class=\"fa fa-pencil\"></i> изменить</a>
                            ";
        }
        // line 28
        echo "                            ";
        if (($this->getAttribute(($context["files_tree"] ?? null), "content_type", array()) == ".md")) {
            // line 29
            echo "                            <a href=\"";
            echo ($context["base_url"] ?? null);
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["files_tree"] ?? null), "sub", array()));
        foreach ($context['_seq'] as $context["_key"] => $context["page"]) {
            // line 38
            echo "                    <li data-name=\"";
            echo $this->getAttribute($context["page"], "file", array());
            echo "\">
                        <div class=\"link\">
                        <i class=\"fa fa-arrows\"></i> &nbsp;
                        <i class=\"fa fa fa-";
            // line 41
            echo $this->getAttribute($context["page"], "type", array());
            echo "-o\"></i> &nbsp; ";
            ...
            echo "\" title=\"удалить\" class=\"text-danger\"><i class=\"fa fa-trash-o\"></i> удалить</a>
                        ...
                        ";
            // line 54
            if (($this->getAttribute($context["page"], "type", array()) == "folder")) {
                // line 55
                echo "                            <ol>
                                ";
                // line 56
                if ($this->getAttribute($context["page"], "sub", array())) {
                    $context['_parent'] = $context;
...
{%include \"@admin/footer.twig\" %}", "@admin/pages.html", "C:\\Users\\NightMan\\Dropbox\\My Site\\lib\\pico_admin\\templates\\pages.html");
    }
}
